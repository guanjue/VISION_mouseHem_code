...
### read info
d1 = read.table('tad.bd.1.mat.p.txt', header=F)
d2 = read.table('tad.bd.2.mat.p.txt', header=F)
d3 = read.table('tad.bd.3.mat.p.txt', header=F)
d4 = read.table('tad.bd.4.mat.p.txt', header=F)
d5 = read.table('tad.bd.5.mat.p.txt', header=F)

d1c = read.table('tad.bd.1.mat.c.txt', header=F)
d2c = read.table('tad.bd.2.mat.c.txt', header=F)
d3c = read.table('tad.bd.3.mat.c.txt', header=F)
d4c = read.table('tad.bd.4.mat.c.txt', header=F)
d5c = read.table('tad.bd.5.mat.c.txt', header=F)
...
write.table(d12345_info_pk_withname, 'TAD_bd_regions.txt', quote=FALSE, col.names=FALSE, row.names=FALSE, sep=' ')
...
pdf('all_p_hist.bd.pdf', height=200)
par(mfrow=c(31,1))
for (i in 1:28){
...
dir.create('IDEAS_input_bd')
for (i in 0:26){
	log10_histp_i = log10_histp[,i+1]
	write.table(log10_histp_i, paste('IDEAS_input_bd/IDEAS_state_bd_p.', i, '.txt', sep=''), quote=FALSE, col.names=FALSE, row.names=FALSE)
}
...
pdf('tad.ideasp.bd.cor.pdf', width = 7, height = 7)
...
pdf('tad.ideasp.bd.cor.cluster.pdf', width = 7, height = 7)
...
dir.create('IDEAS_input_merged_bd')
for (i in 1:ncluster){
	log10_histp_i = d12345_IDEASps_merged_s_log10[,i]
	write.table(log10_histp_i, paste('IDEAS_input_merged_bd/IDEAS_state_bd_p.', i, '.txt', sep=''), quote=FALSE, col.names=FALSE, row.names=FALSE)
}
