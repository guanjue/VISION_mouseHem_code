...
cat G1E.hic.*.*.bed | sort -k1,1 -k2,2n > G1E.hic.tad_and_bd.bed
...
### pool tad and bd
cat G1E.hic.tad.*.sub.bed G1E.hic.boundary.*.bed | sort -k1,1 -k2,2n > G1E.hic.tad_and_bd.bed

### loop TAD level
mkdir IDEAS_state_coverage_tad_and_bd
cp G1E.hic.tad_and_bd.bed G1E.hic.tad_and_bd.mat.c.txt
cp G1E.hic.tad_and_bd.bed G1E.hic.tad_and_bd.mat.p.txt
...
#rm 'ER4.state.'$i'.bed'
#########
bedtools coverage -a G1E.hic.tad_and_bd.bed -b 'ER4.state.'$i'.merge.bed' > 'G1E.hic.tad_and_bd.ER4.IDEAS.info.'$i'.txt'
### get count
cut -f7 'G1E.hic.tad_and_bd.ER4.IDEAS.info.'$i'.txt' > 'G1E.hic.tad_and_bd.ER4.IDEAS.region.'$i'.txt'
paste 'G1E.hic.tad_and_bd.mat.c.txt' 'G1E.hic.tad_and_bd.ER4.IDEAS.region.'$i'.txt' > 'G1E.hic.tad_and_bd.mat.c.txt.tmp' \
&& mv 'G1E.hic.tad_and_bd.mat.c.txt.tmp' 'G1E.hic.tad_and_bd.mat.c.txt'
rm 'G1E.hic.tad_and_bd.ER4.IDEAS.region.'$i'.txt'
### get percentage
cut -f9 'G1E.hic.tad_and_bd.ER4.IDEAS.info.'$i'.txt' > 'G1E.hic.tad_and_bd.ER4.IDEAS.percentage.'$i'.txt'
paste 'G1E.hic.tad_and_bd.mat.p.txt' 'G1E.hic.tad_and_bd.ER4.IDEAS.percentage.'$i'.txt' > 'G1E.hic.tad_and_bd.mat.p.txt.tmp' \
&& mv 'G1E.hic.tad_and_bd.mat.p.txt.tmp' 'G1E.hic.tad_and_bd.mat.p.txt'
rm 'G1E.hic.tad_and_bd.ER4.IDEAS.percentage.'$i'.txt'
#########
### mv files into folder
#mv 'ER4.state.'$i'.merge.bed' IDEAS_state_coverage_level_separate
mv 'G1E.hic.tad_and_bd.ER4.IDEAS.info.'$i'.txt' IDEAS_state_coverage_tad_and_bd
done
