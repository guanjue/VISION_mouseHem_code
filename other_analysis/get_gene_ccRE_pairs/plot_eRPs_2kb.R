...
tss_eRPs = read.table('~/group/projects/vision/rna/tss_eRP_2kb.txt', header=T)
dist_eRPs = read.table('~/group/projects/vision/rna/dist_eRP_2kb.txt', header=T)
...
png('eRPs.2kb.png', width=200)
pheatmap(all_mat[order(all_rowsum),], color=my_colorbar, cluster_rows = FALSE, cluster_cols = F,annotation_names_row=FALSE,annotation_names_col=FALSE,show_rownames=T,show_colnames=T)
dev.off()

pdf('eRPs.2kb.hclust.pdf', width=4)
