...
tss_eRPs_4G = read.table('~/group/projects/vision/rna/tss_eRP_2kb.cor.txt', header=T)
dist_eRPs_4G = read.table('~/group/projects/vision/rna/dist_eRP_2kb.cor.txt', header=T)


tss_eRPs_1G = read.table('~/group/projects/vision/rna/tss_eRP_2kb.nosplit4G.cor.txt', header=T)
dist_eRPs_1G = read.table('~/group/projects/vision/rna/dist_eRP_2kb.nosplit4G.cor.txt', header=T)

eRPs0 = cbind(read.table('~/group/projects/vision/rna/get_ccRE_gene_pair_nofilter/cor0.txt', header=F)[,-1])
...
pdf('eRPs.2kb.all.cor.pdf', width=4)
...
png('eRPs.2kb.cor.png', width=200)
pheatmap(eRP_all[order(all_rowsum),], color=my_colorbar_scale, breaks = breaksList_scale, cluster_rows = FALSE, cluster_cols = F,annotation_names_row=FALSE,annotation_names_col=FALSE,show_rownames=T,show_colnames=T)
dev.off()

pdf('eRPs.2kb.hclust.cor.pdf', width=4)
...
pdf('pknorm_2_16lim_ref1mo_0424_heatmap.eRP_sort.cor.pdf', width=4)
...
pdf('pknorm_2_16lim_ref1mo_0424_heatmap.eRP_sort.hclust.cor.pdf', width=4)
createHeatmap_sort_eRP('~/group/projects/vision/pknorm_2_16lim_ref1mo_sample1mo_0424/pknorm_2_16lim_ref1mo_0424_lesshet.para0', sortstate=TRUE)
dev.off()
