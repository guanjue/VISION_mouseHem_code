...
write.table(tss_eRP, 'tss_eRP_2kb.100iter.txt', sep='\t', quote=F, row.names=T, col.names=T)
write.table(dist_eRP, 'dist_eRP_2kb.100iter.txt', sep='\t', quote=F, row.names=T, col.names=T)
