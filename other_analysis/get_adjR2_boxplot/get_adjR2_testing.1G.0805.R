...
pdf(paste('tss_vs_distal.all4.pdf', sep=''), width=3.5, height=3.5)
boxplot(cbind(adjR2_vec_mean, adjR2_vec_tss, adjR2_vec_dist, adjR2_vec_all), col=c('gray', 'red', 'blue', 'orange'), names = c('M', 'P', 'D', 'P & D'), ylim=c(-0.3,1))
dev.off()
